...
public class MenuConstants {
    ...
    public static final String ORDER_STATUS_CHANGE_TO_AWAITING_STOCK_VALIDATION_INTEGRATION_EVENT_V2 = "OrderStatusChangedToAwaitingStockValidationIntegrationEventV2";

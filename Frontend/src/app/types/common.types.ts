...
export interface SocialLink {
    href: string;
    ariaLabel: string;
    icon: IconType | React.ElementType | string; // Allow string identifiers for serialization
}
...
export interface SidebarNavigationProps {
    ...
    activeItem: number;
    onNavLinkClick: (event: React.MouseEvent<HTMLAnchorElement>, index: number, anchor: string) => void;
}

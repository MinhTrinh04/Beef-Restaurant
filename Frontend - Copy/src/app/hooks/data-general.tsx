...
export const socialIconsData = [
    {
        ...
        ariaLabel: "Facebook",
        icon: "FaFacebookF", // String identifier instead of React component
    },
    {
        href: "http://www.twitter.com",
        ariaLabel: "Twitter",
        icon: "FaXTwitter", // String identifier instead of React component
    },
    {
        href: "http://www.instagram.com",
        ariaLabel: "Instagram",
        icon: "FaInstagram", // String identifier instead of React component
    },
];
